...
local music = browser .. " --ssb https://music.apple.com"
local ai = browser .. " --ssb https://claude.ai"
...
-- Theming
hl.env("GTK_THEME", "catppuccin-macchiato-mauve-standard+default")
...
hl.config({
    general = {
        ...
        col = {
            active_border = {
                colors = {colors.mauve, colors.sky},
                angle = 45
            },
...
local mainMod = "SUPER" -- Sets "Left GUI" key as main modifier
...
hl.bind(mainMod .. " + DELETE", hl.dsp.exec_cmd(launcher))
hl.bind(mainMod .. " + R", hl.dsp.exec_cmd(runner))

-- Screenshots and recordings
hl.bind(mainMod .. " + G",
    hl.dsp.exec_cmd("grimblast --notify copysave area ~/data/pictures/$(date +%Y%m%d_%H%M%S).png"))
hl.bind(mainMod .. " + SHIFT + G", hl.dsp.exec_cmd("~/.config/hypr/scripts/toggle-record.sh"))

-- Emojis
hl.bind(mainMod .. " + E", hl.dsp.exec_cmd("rofimoji --skin-tone neutral --action copy --files emoji --typer ydotool"))

-- Dictation
hl.bind(mainMod .. " + D", hl.dsp.exec_cmd("hyprvoice toggle"))
